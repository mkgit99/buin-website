...
const ArticleGrid = () => {
    ...
    const expandedIndex = expandedId ? articlesData.findIndex(a => a.id === expandedId) : -1;
    const isInFirstRow = expandedIndex !== -1 && expandedIndex < columns;
    const shouldMoveToTop = columns > 1 && isInFirstRow;

    const featuredArticle = shouldMoveToTop ? articlesData.find(a => a.id === expandedId) : null;
